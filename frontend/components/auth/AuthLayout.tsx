...
export function AuthLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left side - Branding */}
      <div className="lg:flex-1 bg-gradient-to-br from-primary via-primary/90 to-secondary relative overflow-hidden">
        {/* Background pattern */}
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full p-8 text-white">
          <div className="max-w-md text-center space-y-6">
            ...
            <p className="text-lg opacity-90 leading-relaxed">
              ...
              intuitive interface and powerful features designed for modern teams.
            </p>
