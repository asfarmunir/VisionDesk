      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="p-10 flex flex-col items-center gap-4 text-center">
          ...
          <div className="flex gap-2">
            ...
            <Button size="sm" onClick={() => router.push("/user/projects")}>
              My Projects
            </Button>
          </div>
        </Card>
          ...
          <div className="space-y-4 max-w-3xl">
            <div className="flex items-center gap-2">
              <Button
                ...
                size="sm"
                onClick={() => router.back()}
                className="inline-flex items-center gap-2  hover: hover:bg-white/10"
              >
                <ArrowLeft className="h-4 w-4" /> Back
              </Button>
              <span className="text-xs ">ID: {project._id.slice(-8)}</span>
            </div>
                ...
                <ul className="space-y-2">
                  {project.teamMembers.map((tm) => (
                    ...
                    >
                      ...
                      <span className="px-2 py-0.5 rounded-md text-[10px] font-medium bg-muted/60 border border-white/10 capitalize">
                        {tm.role}
                      </span>
                    </li>
                  ))}
